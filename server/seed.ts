...
const defaultUiSettings = [
  ...
  { key: "show_mada", value: "true", category: "cart", description: "إظهار الدفع بمدى" },
  { key: "show_stc_pay", value: "true", category: "cart", description: "إظهار الدفع بـ STC Pay" },
  { key: "show_apple_pay", value: "false", category: "cart", description: "إظهار الدفع بـ Apple Pay" },
  { key: "show_visa", value: "true", category: "cart", description: "إظهار الدفع بفيزا" },
  { key: "show_mastercard", value: "true", category: "cart", description: "إظهار الدفع بماستركارد" },
  { key: "show_tabby", value: "false", category: "cart", description: "إظهار الدفع بتابي (تقسيط)" },
  { key: "show_tamara", value: "false", category: "cart", description: "إظهار الدفع بتمارا (تقسيط)" },
  { key: "show_wallet_payment", value: "false", category: "cart", description: "إظهار الدفع بالمحفظة الإلكترونية" },
  { key: "show_online_payment", value: "false", category: "cart", description: "إظهار الدفع الإلكتروني العام" },
  ...
  { key: "store_timezone", value: "Asia/Riyadh", category: "general", description: "المنطقة الزمنية للمتجر (مثال: Asia/Riyadh)" },
